...
var getColors = url => {
  ...
  visionResponse.open(
    "POST",
    "https://vision.googleapis.com/v1/images:annotate?key=AIzaSyA9EHeI2lrYJnjfEMhI0rU-J8yyfAOSOAs",
    !0
  );
  ...
  visionResponse.onload = function() {
    ...
    colorsArray = JSON.parse(visionResponse.response).responses[0]
