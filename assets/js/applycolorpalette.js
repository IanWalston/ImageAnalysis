...
let applyColorPallet = function() {
  $(document).ready(function() {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      let newDiv = $("<div>")
        .text(" ")
        .css(`background-color`, newObj.color)
        .css("min-height", "64px")
        .attr("id", `colorDisplay${i}`);
    ...
    let displayInfoButton = $("<button>")
      .text("click to display palette info")
      .addClass("pure-u-5-5")
      .css("min-height", "64px")
      .attr("id", "displayInfoButton");
    ...
    displayInfoButton.css(
      "background-image",
      `linear-gradient(to right, ${sortedColors[0].color}, ${
        sortedColors[1].color
      }, ${sortedColors[2].color}, ${sortedColors[3].color}, ${
        sortedColors[4].color
      }, ${sortedColors[5].color}, ${sortedColors[6].color}, ${
        sortedColors[7].color
      }, ${sortedColors[8].color}, ${sortedColors[9].color}`
    );
    ...
    $(".brand-title").animate(function(now, fx) {
    ...
    $(".xyz").hover(
      function() {
        $(this)
          .css("background-color", sortedColors[6].color)
          .css("color", sortedColors[2].color);
      },
      function() {
        $(this)
          .css("background-color", sortedColors[7].color)
          .css("color", sortedColors[3].color);
      }
    );
    $(".color-button").hover(
      function() {
    ...
    $(".palette")
      ...
      .css("border-color", sortedColors[2].color)
