exampleUrlsArr = [
  {
    url:
      "https://images.unsplash.com/photo-1534409039973-740b2b5d82e8?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1030&q=80",
    name: "strawberry"
  },
  {
    url:
      "https://images.unsplash.com/photo-1502741338009-cac2772e18bc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80",
    name: "blueberry"
  },
  {
    url:
      "https://images.unsplash.com/photo-1533017232161-9e487b18e41d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80",
    name: "pug"
  },
  {
    url:
      "https://images.unsplash.com/photo-1526452765549-517b13adb4f6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80",
    name: "calico"
  },
  {
    url:
...
$("#example-buttons")
  .append($("<p id='try'>").text("Or try one of these."))
  .addClass("ani4");

exampleUrlsArr.forEach(urlname => {
  let button = $("<button>")
    .addClass("xyz pure-u-1-5")
    .text(urlname.name)
    .addClass("ani5");
  button.on("click", () => {
